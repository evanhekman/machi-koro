...
class MachiKoroNet(nn.Module):
    ...
    def dice_logits(self, x):   return self.dice_head(self._h(x))
    def reroll_logits(self, x): return self.reroll_head(self._h(x))
    def buy_logits(self, x):    return self.buy_head(self._h(x))
